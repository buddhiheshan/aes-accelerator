...
# Generated on: Sun Nov 16 18:32:43 EST 2025 (Sun Nov 16 23:32:43 UTC 2025)
...
set logfile fv/mux4to1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mux4to1 -revised fv_map -use_rtl_names
...
add_search_path /home/jy5187/Documents/soc/aes-accelerator/cpu/example -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/jy5187/Documents/soc/aes-accelerator/cpu/example/example.v
elaborate_design -golden -root {mux4to1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mux4to1/fv_map.v.gz
...
set_analyze_option -mapping_file fv/mux4to1/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mux4to1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mux4to1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mux4to1.rtl.fv_map.rpt
