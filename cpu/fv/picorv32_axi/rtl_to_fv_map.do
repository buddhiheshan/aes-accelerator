...
# Generated on: Thu Nov 06 20:25:08 EST 2025 (Fri Nov 07 01:25:08 UTC 2025)
...
set logfile fv/picorv32_axi/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/picorv32_axi -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/eda/cadence/DDI231/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/eda/cadence/DDI231/GENUS231/tools.lnx86"
set env(CW_DIR) "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/eda/cadence/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /ip/tsmc/tsmc16adfp/stdcell/CCS -library -both
...
add_search_path /home/jy5187/Documents/soc/aes-accelerator/cpu/picorv32 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/jy5187/Documents/soc/aes-accelerator/cpu/picorv32/picorv32.v
elaborate_design -golden -root {picorv32_axi} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/picorv32_axi/fv_map.v.gz
elaborate_design -revised -root {picorv32_axi}
...
set_analyze_option -mapping_file fv/picorv32_axi/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32_axi.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32_axi.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32_axi.rtl.fv_map.rpt
