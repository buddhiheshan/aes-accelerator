...
phys::read_script syn/outputs/output_Nov06/picorv32_axi.root.g


# Libraries
################################################################################
::legacy::set_attribute library {/ip/tsmc/tsmc16adfp/stdcell/CCS/N16ADFP_StdCellss0p72v125c_ccs.lib} /


# Design
################################################################################
read_netlist -top picorv32_axi syn/outputs/output_Nov06/picorv32_axi.v
read_metric -id current syn/outputs/output_Nov06/picorv32_axi.metrics.json

phys::read_script syn/outputs/output_Nov06/picorv32_axi.g

phys::read_lec_taf syn/outputs/output_Nov06/picorv32_axi.lec.taf.gz
phys::read_taf syn/outputs/output_Nov06/picorv32_axi.safety.taf.gz
