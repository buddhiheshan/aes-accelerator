...
# Created by Genus(TM) Synthesis Solution 23.14-s090_1 on Thu Nov 06 20:25:14 EST 2025

# This file contains the Genus script for design:picorv32_axi

######################################################################

set_db -quiet information_level 7
set_db -quiet init_lib_search_path /ip/tsmc/tsmc16adfp/stdcell/CCS
...
set_db -quiet runtime_by_stage {{to_generic 27 107 28 75} {first_condense 19 135 25 110} {PBS_Generic_Opt-Post 57 137 58.46845400000001 105.44827000000001} {{PBS_Generic-Postgen HBO Optimizations} 0 137 0.0 105.44827000000001} {PBS_TechMap-Start 0 140 0.0 108.44827000000001} {{PBS_TechMap-Premap HBO Optimizations} 1 141 1.0 109.44827000000001} {first_condense 20 161 25 141} {reify 21 182 43 185} {global_incr_map 4 186 4 190} {{PBS_Techmap-Global Mapping} 45 186 46.04928899999993 155.49755899999994} {{PBS_TechMap-Datapath Postmap Operations} 4 190 3.949502999999993 159.44706199999993} {{PBS_TechMap-Postmap HBO Optimizations} 0 190 -0.04999300000000062 159.39706899999993} {{PBS_TechMap-Postmap Clock Gating} 1 191 1.0 160.39706899999993} {{PBS_TechMap-Postmap Cleanup} 0 191 -0.04771500000001083 160.34935399999992} {PBS_Techmap-Post_MBCI 0 191 0.0 160.34935399999992} {incr_opt 5 196 4 199} }
...
## Written on 20:25:15 06-Nov 2025
#############################################################
#####   Flow Definitions   ##################################
