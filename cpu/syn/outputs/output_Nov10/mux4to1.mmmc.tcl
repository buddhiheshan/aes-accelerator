...
create_library_set -name default_emulate_libset_max \
    -timing { /ip/tsmc/tsmc16adfp/stdcell/CCS/N16ADFP_StdCellss0p72v125c_ccs.lib \
              ...
              /ip/tsmc/tsmc16adfp/pll/LIB/n16adfp_pllff0p88v1p98vm40c.lib \
              /ip/tsmc/tsmc16adfp/pll/LIB/n16adfp_pllss0p72v1p62v125c.lib \
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { syn/outputs/output_Nov10/mux4to1.default_emulate_constraint_mode.sdc }
