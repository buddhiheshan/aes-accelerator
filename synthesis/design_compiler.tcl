...
set ADDITIONAL_SEARCH_PATH  "$PDK_DIR/NLDM $PDK_DIR2/NLDM $PDK_DIR3/NLDM $PDK_DIR/NDM $PDK_DIR2/NDM ../rtl/aes ../rtl/aes/pkgs ../rtl/cpu ../rtl/SRAM ../rtl ../constraints";#Directories containing logic libraries, logic design and script files.
...
write -format verilog -hierarchy -output output/system_top.v
write_sdc output/post_syn.sdc
